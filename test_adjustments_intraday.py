"""
Test is_intraday adjustments con FX e Dividend.
...
def test_intraday_incremental():
    ...
    adjuster = Adjuster(initial_prices, instruments=instruments, is_intraday=True)
    ...
    # Calculate initial
    adj_initial = adjuster.calculate_adjustments()
    print(f"\n2. Initial calculate:")
    ...
    print(f"\n3. Update (append_update): adding {len(day3_prices)} timestamps (day 3)")
    adjuster.append_update(prices=day3_prices, fx_prices=day3_fx, recalc_last_n=1)
    print(f"   Cache size after update: {len(adjuster._adjustments)} timestamps")

    # Calculate (dovrebbe usare cache)
    adj_day3 = adjuster.calculate_adjustments()
    ...
    print(f"\n5. Update (append_update): adding {len(day4_prices)} timestamps (day 4)")
    adjuster.append_update(prices=day4_prices, fx_prices=day4_fx, recalc_last_n=1)
    print(f"   Cache size after update: {len(adjuster._adjustments)} timestamps")

    # Final calculate
    adj_final = adjuster.calculate_adjustments()
    print(f"\n6. Final calculate:")

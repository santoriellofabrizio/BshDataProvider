...
def test_timescale_bond_anagraphic(api):
    """Bond anagraphic ETF requests performance."""

    result = api.general.get_bond_isins(classe=(9,10))

    print(f"N bonds: {len(result)}")
    assert result, "Expected non-empty bond DataFrame"
